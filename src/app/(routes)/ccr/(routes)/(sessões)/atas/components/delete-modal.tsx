...
export function DeleteModal({ isOpen, minutesNumber, onClose, onConfirm }: DeleteModalProps) {
          ...
          <div className="space-y-4">
            ...
            <div>
              <p className="text-sm text-gray-700 mb-2">
                Você está prestes a excluir a seguinte ata:
              </p>
              <div className="bg-red-50 border border-red-200 rounded-lg p-3">
                <p className="text-sm font-semibold text-gray-900">{minutesNumber}</p>
              </div>
            </div>
              ...
              <div className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-yellow-800 mt-1">
                    Esta ação não poderá ser desfeita e a ata será removida permanentemente.
                  </p>
                </div>
              </div>
            </div>
